...
class TestPartie(unittest.TestCase):
    ...
    def test_joueur_actif_initial(self):
        """Test 1: Vérification que le joueur Rouge commence, après tirage au sort."""
        partie = Partie("Eve", "Frank")
        partie.demarrer()
        # Après demarrer(), le tirage au sort a eu lieu :
        # le joueur actif doit toujours être celui qui a reçu le Rouge,
        # quelle que soit l'issue du tirage.
