...
class Tapis:
    ...
    def __init__(self, largeur=LARGEUR_DEFAUT, hauteur=HAUTEUR_DEFAUT,
                 nb_boules_grises=9, nb_boules_bleues=2):
        """Initialise un tapis vierge."""
        self.largeur = largeur
        self.hauteur = hauteur
        self.nb_boules_grises = nb_boules_grises
        self.nb_boules_bleues = nb_boules_bleues
        self.boules = []
